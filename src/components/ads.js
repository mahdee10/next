...
export default function Ads(props){
  ...
  useEffect(() => {
    ...
    return (
        <div onClick={handleClick} ref={adRef} className="cursor-pointer sm:pl-9 pl-4 sm:pr-7 pr-4 flex flex-col rounded-xl sm:w-half w-full content-end sm:mb-0 mb-3">
            <Image className='sm:pt-9 pt-4 '   src={props.path} alt="Search Icon"></Image>
